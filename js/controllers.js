...
function SearchCtrl($scope, $sce, $routeParams, $location, elastic, configuration, aggregateBuilder, $modal, queryStorage) {
    ...
    function searchPart() {
        ...
        if ($scope.search.doAdvanced && $scope.search.advanced.searchFields.length > 0) {
            ...
            executedQuery = {"function_score": {"query": {"query_string": {"query": $scope.search.simple, "fields": ["_all"], "use_dis_max": true}},"functions":[{"filter": {"type": {"value": "irc_log"}}, "boost_factor": 0.25}]}};
        } else {
